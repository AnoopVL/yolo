          ...
          <div className="row">
            <div className="col-md-4">
              <div className="yolomy-div">
                <div className="yolomy">ViCHAr</div>
                <p className="yolomy-desc">
                  WE ARE ViCHAr - WE UNDERSTAND <br />
            ...
            <div className="col-md-4">
              <div className="footer-links-slogan float-md-right">
                ...
                <div className="slogan yolomy">ViCHAr: We Mean Fashion</div>
              </div>
            </div>
            ...
            <div className="col-12">
              <p className="text-center copyrights">COPYRIGHT, ViCHAr INC</p>
            </div>
          </div>
        </div>
      </div>
